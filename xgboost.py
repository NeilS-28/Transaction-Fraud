...
# XGBoost specific feature importance plot (built-in)
plt.figure(figsize=(10, 8))
...
print(f"Reg Lambda (L2): {model.reg_lambda}")
...
plt.figure(figsize=(10, 6))
plt.hist(y_probs[y_test == 0], bins=50, alpha=0.7, label='Normal Transactions', density=True)
plt.hist(y_probs[y_test == 1], bins=50, alpha=0.7, label='Fraud Transactions', density=True)
